  ...
  <v-dialog v-model="dialog" width="600px">
    ...
    <v-card>
      ...
      <v-card-text>
        ...
        <article>
          <h2 class="titulo2">Northside Youth Soccer League</h2>
          <h3 class="titulo3">RULES OF PLAY & POLICIES</h3>
          <p class="titulo3NYSLrules">
            FIFA rules shall govern NYSL play except as modified herein
          </p>
          <span class="negrilla">SPORTSMANSHIP</span>
          <ul class="listaestilocuadrados">
            <li>
              The common interest that members of the Association share is to inspire
              youth to practice the ideals of sportsmanship and fair play. Any subplayer,
          ...
          <span class="negrilla">FIFA FIELD REGULATIONS</span>
          <ol>
            <li>
              <b class="negrilla">DIMENSIONS. </b><span>FIFALaw 1 provides for flexible external field dimensions
                ...
                and older.</span></li>
            <li>
              <span class="negrilla">COMPETITION FIELDS. </span> Fields used within the competition program must
            ...
            <li><span class="negrilla">FIELDS USED BY YOUNG AGE GROUPS.</span>
              <ol class="listaestiloletras">
                <li>
            ...
            <li><span class="negrilla">TEAM BENCH AREAS</span>
              <ol class="listaestiloletras">
          ...
          <span class="negrilla">EQUIPMENT</span>
          <ul class="listaestilocuadrados">
            <li>
          ...
          <span class="negrilla">NUMBER OF PLAYERS</span>
          <ul class="listaestilocuadrados">
            <li>
              <span class="negrilla">TEAM SIZE.</span> Except as noted below, team rosters shall consist of not less
            ...
            <li><span class="negrilla">SIZE OF AGE GROUP TEAMS.SIZE OF AGE GROUP TEAMS.</span>S. In order to give player’s maximum
          ...
          <span class="negrilla">SUBSTITUTIONS</span>
          <ul class="listaestilocuadrados">
          ...
          <span class="negrilla">CONFISCATED PLAYER PASSES</span>
          <ul class="listaestilocuadrados">
            <li>
          ...
          <span class="negrilla">ALL-PLAY</span>
          <ul class="listaestilocuadrados">
          ...
          <span class="negrilla">PLAYERS’ EQUIPMENT</span>
          <ul class="listaestilocuadrados">
            <li>
          ...
          <span class="negrilla">MIXED TEAMS</span>
          <ul class="listaestilocuadrados">
            <li><span class="negrilla">GIRLS PLAYING ON BOYS’ TEAMS. </span>Girls are eligible to play on boys’
              4
              teams with parent/guardian permission
            </li>
            <li><span class="negrilla">TYPES OF TEAMS.</span>S. Teams with females only are Girls Teams. All others
              are Boys Teams.
            </li>
          </ul>
          <span class="negrilla">COACHING FROM THE SIDELINES</span>
          <ul class="listaestilocuadrados">
          ...
          <span class="negrilla">GAME TERMINATION</span>
          <ul class="listaestilocuadrados">
          ...
          <span class="negrilla">CONDITIONS OF REPLAY OF GAMES</span>
          <ul>
          ...
          <span class="negrilla">REFEREE RESPONSIBLITIES</span>
          <ul class="listaestilocuadrados">
